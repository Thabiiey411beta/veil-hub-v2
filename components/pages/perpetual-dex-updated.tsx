...
export default function PerpetualDEXUpdated() {
  ...
  const pairs = [
    { symbol: 'BTC/USDC', price: 42850, change: '+2.5%', volume: '$1.2B', icon: '₿' },
    { symbol: 'ETH/USDC', price: 2450, change: '+1.8%', volume: '$850M', icon: 'Ξ' },
    { symbol: 'LINK/USDC', price: 18.50, change: '+3.2%', volume: '$320M', icon: '🔗' },
    { symbol: 'AVAX/USDC', price: 35.20, change: '+1.1%', volume: '$180M', icon: '▲' },
  ];
            ...
            <div className="space-y-2">
              {pairs.map((pair) => (
                ...
                >
                  ...
                  <div className="flex justify-between text-xs text-[#808080] ml-6">
        ...
        <div className="mt-8 border border-[#FFD700]/20 rounded-lg p-6 hover:border-[#FFD700]/50 transition-all">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="text-center p-4 border border-[#FFD700]/20 rounded-lg hover:border-[#FFD700]/50 transition-all">
                <div className="text-[#808080] text-xs mb-2">{item.label}</div>
                <div className="text-[#FFD700] font-bold mb-2">{item.value}</div>
